# -*- coding: utf-8 -*-
#
# Disdat documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Disdat.tex', u'Disdat Documentation',
     u'Ken Yocum', 'manual'),
]
...
man_pages = [
    (master_doc, 'disdat', u'Disdat Documentation',
     [authors], 1)
]
...
texinfo_documents = [
    (master_doc, 'Disdat', u'Disdat Documentation',
     authors, 'Disdat', 'One line description of project.',
     'Miscellaneous'),
]
