...
from tests.functional.common import TEST_CONTEXT, init_project
...
def test_add_directory(tmpdir):
    ...
    level_1 = 'first'
    os.mkdir(os.path.join(str(tmpdir), level_1))
    ...
    path_dict[test_csv_name] = (test_csv_abs_path, test_csv_path.split('/')[1:])
    ...
    path_dict[test_text_1_name] = (test_text_name_1_abs_path, test_text_1_path.split('/')[1:])
    ...
    path_dict[test_text_2_name] = (test_text_name_2_abs_path, test_text_2_path.split('/')[1:])
    ...
    path_dict[test_text_3_name] = (test_text_name_3_abs_path, test_text_3_path.split('/')[1:])
    ...
    path_dict[test_text_4_name] = (test_text_name_4_abs_path, test_text_4_path.split('/')[1:])
    ...
    add_dir = os.path.join(str(tmpdir), level_1)
    api.add(TEST_CONTEXT, 'test_directory', add_dir)
    ...
    add_dir = os.path.join(str(tmpdir), level_1)
    api.add(TEST_CONTEXT, 'test_directory', add_dir, tags=tag)
