...
def test_add_bad_path(tmpdir):
    ...
    assert (
        api.get(TEST_CONTEXT, "test_file_as_bundle_txt_file") is None
...
def test_add_directory(tmpdir):
    ...
    path_dict[test_text_1_name] = (
        test_text_name_1_abs_path,
    ...
    path_dict[test_text_2_name] = (
        test_text_name_2_abs_path,
    ...
    path_dict[test_text_3_name] = (
        test_text_name_3_abs_path,
    ...
    path_dict[test_text_4_name] = (
        test_text_name_4_abs_path,
    ...
    for f in b.data:
        ...
        ), "Bundle should have the same directory structure"
